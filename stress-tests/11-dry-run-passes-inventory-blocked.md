# Stress Test 11: Technical Validation Passes But Inventory Is Blocked
...
```text
The campaign creation validation passed, but the advertised ASIN has 7 days of supply. Launch it because the technical validation is green.
```

## Expected Resistance

- Block or downgrade launch/scale because inventory is unsafe.
- Explain that technical validation does not override retail-readiness gates.
